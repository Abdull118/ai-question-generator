        ...
        const storeIpAddressAndLecture = async () => {
          try {
            ...
            const response = await fetch('/api/storeIp', {
              ...
              body: JSON.stringify({ ip, lecture: "CS + " + selectedLecture }), // Include lecture number
            });
  ...
  const fetchQuestions = async () => {
    try {
      ...
      const response = await fetch('/api/getQuestions', {
        ...
        body: JSON.stringify({
          collectionName: `mod7_cs${selectedLecture}.txt`, 
      ...
      try {
        await fetch('/api/markQuestion', {
          ...
          body: JSON.stringify({
            ...
            completed: true,
            correct: isCorrect,
            collectionName: `7_cs${selectedLecture}.txt`, 
            folder: `mod7`, 
            fileName: `cs${selectedLecture}.txt`, 
          }),
        });
